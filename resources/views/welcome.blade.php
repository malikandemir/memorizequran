            ...
            <div>
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold dark:text-white-900">Quran Pages</div>
                    </div>
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <form method="post" action="/memorized" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <button type="submit"
                                        class="bg-red-500 dark:bg-red-800 text-blue-900 dark:text-gray-900">
                                    I Memorized {{ $memorizePage->page_number }}. Page
                                </button>
                            </form>
                        </div>
                    </div>
